...
Usage:
    python -m egdc.mog.train --epochs 100 --model_size tiny
    python -m egdc.mog.train --epochs 50 --batch_size 16 --num_samples 50000 --eval_every 5
"""
...
from egdc.mog.tokenizer import MogCodeTokenizer, MASK_TOKEN, PAD_TOKEN
from egdc.mog.dataset import MogDataset
