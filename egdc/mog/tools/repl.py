...
from egdc.mog.solvers.program_search import robust_search_program
from egdc.mog.solvers.search_solver import (
...
class MogREPL:
    def __init__(self, memory_root: str = "egdc/mog/routing/pathway_memory"):
