...
Usage:
    python -m egdc.python.train --dataset humaneval --epochs 100 --model_size tiny
    python -m egdc.python.train --dataset humaneval --epochs 50 --batch_size 8 --eval_every 10
"""
...
from egdc.python.tokenizer import PythonCodeTokenizer, MASK_TOKEN, PAD_TOKEN
...
def main() -> None:
    ...
    if args.eval_humaneval:
        ...
        from egdc.core.humaneval import evaluate_humaneval
        tokenizer = PythonCodeTokenizer()
