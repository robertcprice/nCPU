...
Usage:
    python -m egdc.mog_solve --num_problems 25
    python -m egdc.mog_solve --variants_per_factory 5 --use_real_compiler --output report.json
"""
...
def main():
    ...
    ap.add_argument("--memory_root", type=str, default="egdc/pathway_memory")
