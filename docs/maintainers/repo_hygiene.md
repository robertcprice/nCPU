...
See also the full reorganization proposal and layering docs:
- `docs/maintainers/REPO_REORGANIZATION_PROPOSAL.md`
- `docs/architecture/HERO_THESIS.md`
...
For a quick pre-push review, see `docs/maintainers/cleanup_checklist.md`.
