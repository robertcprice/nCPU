// Auto-generated by nCPU LOOP-3C generated backend (BackendIR).
...
fn handle_connection(mut stream: TcpStream, store: Arc<dyn EventStore>) -> io::Result<()> {
    ...
    match (method.as_str(), path.as_str()) {
        ("GET", "/health") => write_response(
            ...
            200,
            &format!(
                "{{\"ok\":true,\"service\":\"generated-rule-backend\",\"store\":\"file\"}}"
            ),
        ),
        ("GET", "/rules") => write_response(
            ...
            200,
            &format!(
                "{{\"rules\":[{{\"name\":\"score_bonus\",\"method\":\"search_polynomial_multi\"}}]}}"
            ),
        ),
        ("GET", "/events") => {
