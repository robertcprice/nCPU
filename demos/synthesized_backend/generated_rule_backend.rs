...
// Description: A function score_bonus that scores ten points per catch plus a five point bonus, score_bonus(0)=5 and score_bonus(1)=15 and score_bonus(2)=25 and score_bonus(4)=45 and score_bonus(-1)=-5 | A function damage_penalty that converts hit points lost into a signed penalty score twice the loss minus three, damage_penalty(0)=-3 and damage_penalty(1)=-1 and damage_penalty(2)=1 and damage_penalty(4)=5 and damage_penalty(5)=7
// Store: file
// Compile:
