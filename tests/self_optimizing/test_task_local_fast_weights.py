...
from ncpu.self_optimizing.architecture.ncpu_adaptation_backend import NCPUAdaptationBackend, NCPUAdaptationConfig
from ncpu.self_optimizing.latent_heads.state_patch_head import StatePatchHead, StatePatchHeadConfig
