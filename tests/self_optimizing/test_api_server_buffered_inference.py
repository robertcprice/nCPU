...
from ncpu.self_optimizing.core.api_server import BufferedInferenceRequest, app, _create_llm_provider
...
class TestBufferedInferenceAPI(unittest.TestCase):
    ...
    def test_internal_infer_repairs_and_commits_code(self):
        ...
        with patch("ncpu.self_optimizing.core.api_server._create_llm_provider", return_value=fake_provider):
    ...
    def test_internal_infer_can_use_separate_action_policy_provider(self):
        ...
        with patch(
            "ncpu.self_optimizing.core.api_server._create_llm_provider",
    ...
    def test_create_llm_provider_uses_action_timeout_overrides(self):
        ...
        with patch("ncpu.self_optimizing.core.llm_provider.LLMProviderFactory.create_provider") as factory:
