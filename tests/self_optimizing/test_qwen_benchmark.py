...
from ncpu.self_optimizing.core.code_verifier import CodeVerifier
from ncpu.self_optimizing.benchmarks.llm_benchmark import ProviderResponse
from ncpu.self_optimizing.benchmarks.run_qwen_benchmark import (
    extract_json_object,
...
class TestQwenBenchmarkFlow(unittest.TestCase):
    ...
    def test_run_model_benchmark_reports_improvements(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch("ncpu.self_optimizing.benchmarks.run_qwen_benchmark.build_provider", return_value=fake_provider):
    ...
    def test_run_model_benchmark_can_use_controller_bundle_defaults(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("ncpu.self_optimizing.benchmarks.run_qwen_benchmark.build_provider", return_value=fake_provider) as build_provider:
                report = run_model_benchmark(
                    provider_name=None,
                    model=None,
