...
from ncpu.self_optimizing.benchmarks.run_real_memory_proof import run_real_memory_proof
...
class TestRealMemoryProof(unittest.TestCase):
    def test_run_real_memory_proof_writes_report(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("ncpu.self_optimizing.benchmarks.run_real_memory_proof.run_model_benchmark", return_value=benchmark_report), \
                 patch("ncpu.self_optimizing.benchmarks.run_real_memory_proof.build_latent_memory_training_bundle", return_value=memory_bundle), \
                 patch("ncpu.self_optimizing.benchmarks.run_real_memory_proof.train_latent_memory_head", return_value=training_metrics), \
                 patch("ncpu.self_optimizing.benchmarks.run_real_memory_proof.evaluate_latent_memory_head", return_value=evaluation_report):
