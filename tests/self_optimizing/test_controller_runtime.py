...
class TestControllerRuntime(unittest.TestCase):
    ...
    def test_load_bundle_latent_action_policy_uses_bundle_checkpoint(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with mock.patch("ncpu.self_optimizing.latent_heads.action_policy.load_latent_action_head", return_value=mock.Mock(config=mock.Mock())) as loader:
    ...
    def test_load_bundle_latent_halt_policy_uses_bundle_checkpoint(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with mock.patch("ncpu.self_optimizing.latent_heads.halt_policy.load_latent_halt_head", return_value=mock.Mock(config=mock.Mock())) as loader:
    ...
    def test_load_bundle_latent_memory_updater_uses_bundle_checkpoint(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with mock.patch(
                "ncpu.self_optimizing.latent_heads.memory_head.load_latent_memory_head",
