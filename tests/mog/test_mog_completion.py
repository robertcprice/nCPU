...
from egdc.mog.tokenizer import MogCodeTokenizer, MASK_TOKEN


def test_mask_function_bodies_preserves_signatures_and_braces():
    from egdc.mog.training.completion import mask_function_bodies
...
def test_build_completion_tokens_keeps_prefix_and_masks_body():
    from egdc.mog.training.completion import build_completion_tokens
...
def test_completion_generation_preserves_fixed_tokens():
    from egdc.mog.training.completion import complete_mog_from_initial
