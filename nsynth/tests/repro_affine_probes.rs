...
fn ex1(x: i64, y: i64) -> Example {
    Example { inputs: vec![Value::Int(x)], expected: Value::Int(y) }
}
fn ex2(a: i64, b: i64, y: i64) -> Example {
    Example { inputs: vec![Value::Int(a), Value::Int(b)], expected: Value::Int(y) }
}
...
fn run1(name: &str, sig: &'static str, f: impl Fn(i64) -> i64) {
    ...
    println!("[{name}] success={} ms={} method={}", r.success, ms, r.method);
}

fn run2(name: &str, sig: &'static str, f: impl Fn(i64, i64) -> i64) {
    let pairs = [(0i64,0i64),(1,2),(2,1),(3,4),(4,3),(5,6),(6,5),(7,2),(2,7),(3,9)];
