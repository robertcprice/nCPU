...
impl WordShape {
    fn name(self) -> &'static str {
        match self {
            ...
            WordShape::JoinWithDotEq => "join_with_dot_eq",
            WordShape::JoinWithCommaEq => "join_with_comma_eq",
            WordShape::JoinWithSemiEq => "join_with_semi_eq",
            WordShape::JoinWithColonSlash => "join_with_colon_slash",
            WordShape::JoinWithBangEq => "join_with_bang_eq",
            ...
            WordShape::JoinWithCaretSlash => "join_with_caret_slash",
            WordShape::JoinWithPipeSlash => "join_with_pipe_slash",
            WordShape::JoinWithDollarSlash => "join_with_dollar_slash",
            WordShape::JoinWithBangSlash => "join_with_bang_slash",
            WordShape::JoinWithQuestionSlash => "join_with_question_slash",
            WordShape::JoinWithAtSlash => "join_with_at_slash",
            WordShape::JoinWithHashSlash => "join_with_hash_slash",
            WordShape::JoinWithDotSlash => "join_with_dot_slash",
            WordShape::JoinWithCommaSlash => "join_with_comma_slash",
            ...
            WordShape::JoinWithEqBang => "join_with_eq_bang",
...
fn apply_word_shape(input: &str, sep: &str, shape: WordShape) -> String {
    ...
    match shape {
        ...
        WordShape::JoinWithDotEq => words.join(".="),
        WordShape::JoinWithCommaEq => words.join(",="),
        WordShape::JoinWithSemiEq => words.join(";="),
        WordShape::JoinWithColonSlash => words.join(":/"),
        WordShape::JoinWithBangEq => words.join("!="),
        ...
        WordShape::JoinWithCaretSlash => words.join("^/"),
        WordShape::JoinWithPipeSlash => words.join("|/"),
        WordShape::JoinWithDollarSlash => words.join("$/"),
        WordShape::JoinWithBangSlash => words.join("!/"),
        WordShape::JoinWithQuestionSlash => words.join("?/"),
        WordShape::JoinWithAtSlash => words.join("@/"),
        WordShape::JoinWithHashSlash => words.join("#/"),
        WordShape::JoinWithDotSlash => words.join("./"),
        WordShape::JoinWithCommaSlash => words.join(",/"),
        ...
        WordShape::JoinWithEqBang => words.join("=!"),
...
WordShape::CapLastWord => format!(
        ...
        WordShape::JoinWithDotEq => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\".=\");\n}}\n"
        ),
        WordShape::JoinWithCommaEq => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\",=\");\n}}\n"
        ),
        WordShape::JoinWithSemiEq => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\";=\");\n}}\n"
        ),
        WordShape::JoinWithColonSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\":/\");\n}}\n"
        ),
        WordShape::JoinWithBangEq => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"!=\");\n}}\n"
        ),
        WordShape::JoinWithQuestionEq => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"?=\");\n}}\n"
        ),
        WordShape::JoinWithAtEq => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"@=\");\n}}\n"
        ),
        ...
        WordShape::JoinWithStarSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"*/\");\n}}\n"
        ),
        ...
        WordShape::JoinWithCaretSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"^/\");\n}}\n"
        ),
        WordShape::JoinWithPipeSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"|/\");\n}}\n"
        ),
        WordShape::JoinWithDollarSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"$/\");\n}}\n"
        ),
        WordShape::JoinWithBangSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"!/\");\n}}\n"
        ),
        WordShape::JoinWithQuestionSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"?/\");\n}}\n"
        ),
        WordShape::JoinWithAtSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"@/\");\n}}\n"
        ),
        WordShape::JoinWithHashSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"#/\");\n}}\n"
        ),
        WordShape::JoinWithDotSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"./\");\n}}\n"
        ),
        WordShape::JoinWithCommaSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\",/\");\n}}\n"
        ),
        WordShape::JoinWithSemiSlash => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\";/\");\n}}\n"
        ),
        WordShape::JoinWithColonBang => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\":!\");\n}}\n"
        ),
        ...
        WordShape::JoinWithEqBang => format!(
            "fn transform({p}: string) -> string {{\n    return {p}.split(\"{sep}\").join(\"=!\");\n}}\n"
        ),
...
pub fn synthesize_word_program(
    ...
    const SHAPES: [WordShape; 148] = [
        ...
        WordShape::JoinWithDotEq,
        WordShape::JoinWithCommaEq,
        WordShape::JoinWithSemiEq,
        WordShape::JoinWithColonSlash,
        WordShape::JoinWithBangEq,
        ...
        WordShape::JoinWithCaretSlash,
        WordShape::JoinWithPipeSlash,
        WordShape::JoinWithDollarSlash,
        WordShape::JoinWithBangSlash,
        WordShape::JoinWithQuestionSlash,
        WordShape::JoinWithAtSlash,
        WordShape::JoinWithHashSlash,
        WordShape::JoinWithDotSlash,
        WordShape::JoinWithCommaSlash,
...
pub fn synthesize_string_int_program(
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'y')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'x')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'w')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'v')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'u')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'t')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'s')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'r')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'q')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'p')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'o')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'n')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'l')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'k')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'i')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'h')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'g')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'f')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'e')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'d')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'c')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| c.eq_ignore_ascii_case(&'b')).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    // Non-hex character count (not 0-9/a-f/A-F).
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| !c.is_ascii_hexdigit()).count() as i64 == *o)
    {
    ...
    // Non-binary character count (not 0-1).
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|c| !c.is_digit(2)).count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    // Non-punctuation character count.
    if examples
        .iter()
        .all(|(s, o)| s.chars().filter(|&c| c != '!' && c != '.' && c != ',' && c != '?' && c != ';' && c != ':').count() as i64 == *o)
    {
        let code = format!(
            "fn transform({p}: string) -> i64 {{\n\
    n: i64 = 0;\n\
    ...
    return n;\n\
        ...
        if verify_str_int(&code, examples) {
            return Some(StrSynthResult {
                success: true,
                code,
                method: "str-non_lower_count".to_string(),
                error: None,
            });
        }
    }
