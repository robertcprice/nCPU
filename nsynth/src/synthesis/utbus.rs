...
enum DualAccum {
    ...
    /// Product of seventh powers of even-valued non-zero elements (none → 1).
    ProductSeventhPowersEvenNonZero,
    /// Product of seventh powers of odd-valued non-zero elements (none → 1).
    ProductSeventhPowersOddNonZero,
    /// Truncating mean of seventh powers of even-valued non-zero elements (none → 0).
    MeanSeventhPowersEvenNonZeroTrunc,
    /// Truncating mean of seventh powers of odd-valued non-zero elements (none → 0).
    MeanSeventhPowersOddNonZeroTrunc,
    /// Sum of eighth powers of even-valued non-zero elements.
    SumEighthPowersEvenNonZero,
    /// Sum of eighth powers of odd-valued non-zero elements.
    SumEighthPowersOddNonZero,
    /// Product of eighth powers of even-valued non-zero elements (none → 1).
    ProductEighthPowersEvenNonZero,
    /// Product of eighth powers of odd-valued non-zero elements (none → 1).
    ProductEighthPowersOddNonZero,
    /// Truncating mean of eighth powers of even-valued non-zero elements (none → 0).
    MeanEighthPowersEvenNonZeroTrunc,
    /// Truncating mean of eighth powers of odd-valued non-zero elements (none → 0).
    MeanEighthPowersOddNonZeroTrunc,
    /// Sum of ninth powers of even-valued non-zero elements.
    SumNinthPowersEvenNonZero,
    /// Sum of ninth powers of odd-valued non-zero elements.
    SumNinthPowersOddNonZero,
    /// Product of ninth powers of even-valued non-zero elements (none → 1).
    ProductNinthPowersEvenNonZero,
    /// Product of ninth powers of odd-valued non-zero elements (none → 1).
    ProductNinthPowersOddNonZero,
    /// Truncating mean of ninth powers of even-valued non-zero elements (none → 0).
    MeanNinthPowersEvenNonZeroTrunc,
    /// Truncating mean of ninth powers of odd-valued non-zero elements (none → 0).
    MeanNinthPowersOddNonZeroTrunc,
    /// Sum of tenth powers of even-valued non-zero elements.
    SumTenthPowersEvenNonZero,
    /// Sum of tenth powers of odd-valued non-zero elements.
    SumTenthPowersOddNonZero,
    /// Product of tenth powers of even-valued non-zero elements (none → 1).
    ProductTenthPowersEvenNonZero,
    /// Product of tenth powers of odd-valued non-zero elements (none → 1).
    ProductTenthPowersOddNonZero,
    /// Truncating mean of tenth powers of even-valued non-zero elements (none → 0).
    MeanTenthPowersEvenNonZeroTrunc,
    /// Truncating mean of tenth powers of odd-valued non-zero elements (none → 0).
    MeanTenthPowersOddNonZeroTrunc,
    /// Sum of eleventh powers of even-valued non-zero elements.
    SumEleventhPowersEvenNonZero,
    /// Sum of eleventh powers of odd-valued non-zero elements.
    SumEleventhPowersOddNonZero,
    /// Product of eleventh powers of even-valued non-zero elements (none → 1).
    ProductEleventhPowersEvenNonZero,
    /// Product of eleventh powers of odd-valued non-zero elements (none → 1).
    ProductEleventhPowersOddNonZero,
    /// Truncating mean of eleventh powers of even-valued non-zero elements (none → 0).
    MeanEleventhPowersEvenNonZeroTrunc,
    /// Truncating mean of eleventh powers of odd-valued non-zero elements (none → 0).
    MeanEleventhPowersOddNonZeroTrunc,
    /// Sum of twelfth powers of even-valued non-zero elements.
    SumTwelfthPowersEvenNonZero,
    /// Sum of twelfth powers of odd-valued non-zero elements.
    SumTwelfthPowersOddNonZero,
    /// Product of twelfth powers of even-valued non-zero elements (none → 1).
    ProductTwelfthPowersEvenNonZero,
    /// Product of twelfth powers of odd-valued non-zero elements (none → 1).
    ProductTwelfthPowersOddNonZero,
    /// Truncating mean of twelfth powers of even-valued non-zero elements (none → 0).
    MeanTwelfthPowersEvenNonZeroTrunc,
    /// Truncating mean of twelfth powers of odd-valued non-zero elements (none → 0).
    MeanTwelfthPowersOddNonZeroTrunc,
    /// Sum of thirteenth powers of even-valued non-zero elements.
    SumThirteenthPowersEvenNonZero,
    /// Sum of thirteenth powers of odd-valued non-zero elements.
    SumThirteenthPowersOddNonZero,
    /// Product of thirteenth powers of even-valued non-zero elements (none → 1).
    ...
    /// Sum of fourteenth powers of even-valued non-zero elements.
    SumFourteenthPowersEvenNonZero,
    /// Sum of fourteenth powers of odd-valued non-zero elements.
    SumFourteenthPowersOddNonZero,
}
...
impl DualAccum {
    fn label(self) -> &'static str {
        match self {
            ...
            DualAccum::ProductSeventhPowersEvenNonZero => "product_seventh_powers_even_non_zero",
            DualAccum::ProductSeventhPowersOddNonZero => "product_seventh_powers_odd_non_zero",
            DualAccum::MeanSeventhPowersEvenNonZeroTrunc => "mean_seventh_powers_even_non_zero_trunc",
            DualAccum::MeanSeventhPowersOddNonZeroTrunc => "mean_seventh_powers_odd_non_zero_trunc",
            DualAccum::SumEighthPowersEvenNonZero => "sum_eighth_powers_even_non_zero",
            DualAccum::SumEighthPowersOddNonZero => "sum_eighth_powers_odd_non_zero",
            DualAccum::ProductEighthPowersEvenNonZero => "product_eighth_powers_even_non_zero",
            DualAccum::ProductEighthPowersOddNonZero => "product_eighth_powers_odd_non_zero",
            DualAccum::MeanEighthPowersEvenNonZeroTrunc => "mean_eighth_powers_even_non_zero_trunc",
            DualAccum::MeanEighthPowersOddNonZeroTrunc => "mean_eighth_powers_odd_non_zero_trunc",
            DualAccum::SumNinthPowersEvenNonZero => "sum_ninth_powers_even_non_zero",
            DualAccum::SumNinthPowersOddNonZero => "sum_ninth_powers_odd_non_zero",
            DualAccum::ProductNinthPowersEvenNonZero => "product_ninth_powers_even_non_zero",
            DualAccum::ProductNinthPowersOddNonZero => "product_ninth_powers_odd_non_zero",
            DualAccum::MeanNinthPowersEvenNonZeroTrunc => "mean_ninth_powers_even_non_zero_trunc",
            DualAccum::MeanNinthPowersOddNonZeroTrunc => "mean_ninth_powers_odd_non_zero_trunc",
            DualAccum::SumTenthPowersEvenNonZero => "sum_tenth_powers_even_non_zero",
            DualAccum::SumTenthPowersOddNonZero => "sum_tenth_powers_odd_non_zero",
            DualAccum::ProductTenthPowersEvenNonZero => "product_tenth_powers_even_non_zero",
            DualAccum::ProductTenthPowersOddNonZero => "product_tenth_powers_odd_non_zero",
            DualAccum::MeanTenthPowersEvenNonZeroTrunc => "mean_tenth_powers_even_non_zero_trunc",
            DualAccum::MeanTenthPowersOddNonZeroTrunc => "mean_tenth_powers_odd_non_zero_trunc",
            DualAccum::SumEleventhPowersEvenNonZero => "sum_eleventh_powers_even_non_zero",
            DualAccum::SumEleventhPowersOddNonZero => "sum_eleventh_powers_odd_non_zero",
            DualAccum::ProductEleventhPowersEvenNonZero => "product_eleventh_powers_even_non_zero",
            DualAccum::ProductEleventhPowersOddNonZero => "product_eleventh_powers_odd_non_zero",
            DualAccum::MeanEleventhPowersEvenNonZeroTrunc => "mean_eleventh_powers_even_non_zero_trunc",
            DualAccum::MeanEleventhPowersOddNonZeroTrunc => "mean_eleventh_powers_odd_non_zero_trunc",
            DualAccum::SumTwelfthPowersEvenNonZero => "sum_twelfth_powers_even_non_zero",
            DualAccum::SumTwelfthPowersOddNonZero => "sum_twelfth_powers_odd_non_zero",
            DualAccum::ProductTwelfthPowersEvenNonZero => "product_twelfth_powers_even_non_zero",
            DualAccum::ProductTwelfthPowersOddNonZero => "product_twelfth_powers_odd_non_zero",
            DualAccum::MeanTwelfthPowersEvenNonZeroTrunc => "mean_twelfth_powers_even_non_zero_trunc",
            DualAccum::MeanTwelfthPowersOddNonZeroTrunc => "mean_twelfth_powers_odd_non_zero_trunc",
            DualAccum::SumThirteenthPowersEvenNonZero => "sum_thirteenth_powers_even_non_zero",
            ...
            DualAccum::SumFourteenthPowersEvenNonZero => "sum_fourteenth_powers_even_non_zero",
            DualAccum::SumFourteenthPowersOddNonZero => "sum_fourteenth_powers_odd_non_zero",
        }
    }
    ...
    fn eval(self, arr: &[i64]) -> Option<i64> {
        ...
        if arr.is_empty() {
            return match self {
                ...
                | DualAccum::MeanSeventhPowersEvenNonZeroTrunc
                | DualAccum::MeanSeventhPowersOddNonZeroTrunc
                | DualAccum::SumEighthPowersEvenNonZero
                | DualAccum::SumEighthPowersOddNonZero
                | DualAccum::MeanEighthPowersEvenNonZeroTrunc
                | DualAccum::MeanEighthPowersOddNonZeroTrunc
                | DualAccum::SumNinthPowersEvenNonZero
                | DualAccum::SumNinthPowersOddNonZero
                | DualAccum::MeanNinthPowersEvenNonZeroTrunc
                | DualAccum::MeanNinthPowersOddNonZeroTrunc
                | DualAccum::SumTenthPowersEvenNonZero
                | DualAccum::SumTenthPowersOddNonZero
                | DualAccum::MeanTenthPowersEvenNonZeroTrunc
                | DualAccum::MeanTenthPowersOddNonZeroTrunc
                | DualAccum::SumEleventhPowersEvenNonZero
                | DualAccum::SumEleventhPowersOddNonZero
                | DualAccum::MeanEleventhPowersEvenNonZeroTrunc
                | DualAccum::MeanEleventhPowersOddNonZeroTrunc
                | DualAccum::SumTwelfthPowersEvenNonZero
                | DualAccum::SumTwelfthPowersOddNonZero
                | DualAccum::MeanTwelfthPowersEvenNonZeroTrunc
                ...
                | DualAccum::SumFourteenthPowersEvenNonZero
                | DualAccum::SumFourteenthPowersOddNonZero
                ...
                | DualAccum::ProductSeventhPowersEvenNonZero
                | DualAccum::ProductSeventhPowersOddNonZero
                | DualAccum::ProductEighthPowersEvenNonZero
                | DualAccum::ProductEighthPowersOddNonZero
                | DualAccum::ProductNinthPowersEvenNonZero
                | DualAccum::ProductNinthPowersOddNonZero
                | DualAccum::ProductTenthPowersEvenNonZero
                | DualAccum::ProductTenthPowersOddNonZero
                | DualAccum::ProductEleventhPowersEvenNonZero
                | DualAccum::ProductEleventhPowersOddNonZero
                | DualAccum::ProductTwelfthPowersEvenNonZero
                | DualAccum::ProductTwelfthPowersOddNonZero
                | DualAccum::ProductThirteenthPowersEvenNonZero
                | DualAccum::ProductThirteenthPowersOddNonZero => Some(1),
                DualAccum::SumCubes
                | DualAccum::DotIndex
                | DualAccum::XorAll
        ...
        match self {
            ...
            DualAccum::ProductSeventhPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductSeventhPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumEighthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumEighthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductEighthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductEighthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumNinthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
                        let q = s.saturating_mul(s);
                        q.saturating_mul(q).saturating_mul(x)
                    })
                    .fold(0i64, i64::saturating_add),
            ),
            DualAccum::SumNinthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductNinthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductNinthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumTenthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
                        let q = s.saturating_mul(s);
                        q.saturating_mul(q).saturating_mul(s)
                    })
                    .fold(0i64, i64::saturating_add),
            ),
            DualAccum::SumTenthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductTenthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductTenthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumEleventhPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
                        let q = s.saturating_mul(s);
                        q.saturating_mul(q).saturating_mul(s).saturating_mul(x)
                    })
                    .fold(0i64, i64::saturating_add),
            ),
            DualAccum::SumEleventhPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductEleventhPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductEleventhPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumTwelfthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
                        let q = s.saturating_mul(s);
                        q.saturating_mul(q).saturating_mul(s).saturating_mul(s)
                    })
                    .fold(0i64, i64::saturating_add),
            ),
            DualAccum::SumTwelfthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductTwelfthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductTwelfthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumThirteenthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumThirteenthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductThirteenthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::ProductThirteenthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
            ...
            DualAccum::SumFourteenthPowersEvenNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 == 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
                        let q = s.saturating_mul(s);
                        q.saturating_mul(q).saturating_mul(s).saturating_mul(s).saturating_mul(s)
                    })
                    .fold(0i64, i64::saturating_add),
            ),
            DualAccum::SumFourteenthPowersOddNonZero => Some(
                arr.iter()
                    .filter(|&&x| x % 2 != 0 && x != 0)
                    .map(|&x| {
                        let s = x.saturating_mul(x);
...
DualAccum::SumSquaresOdds => format!(
    ...
    return total;\n\
            ...
            DualAccum::ProductSeventhPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item % 2 == 0 {{\n\
    ...
    return prod;\n\
            ...
            DualAccum::ProductSeventhPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item % 2 != 0 {{\n\
    ...
    return prod;\n\
            ...
            DualAccum::MeanSeventhPowersEvenNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
    ...
    return total / n;\n\
            ...
            DualAccum::MeanSeventhPowersOddNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
    ...
    return total / n;\n\
            ...
            DualAccum::SumEighthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    for item in arr {{\n\
        if item % 2 == 0 {{\n\
    ...
    return total;\n\
            ...
            DualAccum::SumEighthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    for item in arr {{\n\
        if item % 2 != 0 {{\n\
    ...
    return total;\n\
            ...
            DualAccum::ProductEighthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item % 2 == 0 {{\n\
    ...
    return prod;\n\
            ...
            DualAccum::ProductEighthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item % 2 != 0 {{\n\
    ...
    return prod;\n\
            ...
            DualAccum::MeanEighthPowersEvenNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
    ...
    return total / n;\n\
            ...
            DualAccum::MeanEighthPowersOddNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
    ...
    return total / n;\n\
            ...
            DualAccum::SumNinthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    for item in arr {{\n\
        if item % 2 == 0 {{\n\
    ...
    return total;\n\
            ...
            DualAccum::SumNinthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    for item in arr {{\n\
        if item % 2 != 0 {{\n\
    ...
    return total;\n\
            ...
            DualAccum::ProductNinthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item % 2 == 0 {{\n\
    ...
    return prod;\n\
            ...
            DualAccum::ProductNinthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item % 2 != 0 {{\n\
    ...
    return prod;\n\
            ...
            DualAccum::MeanNinthPowersEvenNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
    ...
    return total / n;\n\
            ...
            DualAccum::MeanNinthPowersOddNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
    ...
    return total / n;\n\
            ...
            DualAccum::SumTenthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    for item in arr {{\n\
        if item % 2 == 0 {{\n\
    ...
    return total;\n\
            ...
            DualAccum::SumTenthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    total: i64 = 0;\n\
    for item in arr {{\n\
        if item % 2 != 0 {{\n\
    ...
    return total;\n\
            ...
            DualAccum::ProductTenthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item % 2 == 0 {{\n\
    ...
    return prod;\n\
            ...
            DualAccum::ProductTenthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item % 2 != 0 {{\n\
    ...
    return prod;\n\
            ...
            DualAccum::MeanTenthPowersEvenNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    n: i64 = 0;
    for item in arr {{
...
"
            ...
            DualAccum::MeanTenthPowersOddNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    n: i64 = 0;
    for item in arr {{
...
"
            ...
            DualAccum::SumEleventhPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    for item in arr {{
        if item % 2 == 0 {{
...
"
            ...
            DualAccum::SumEleventhPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    for item in arr {{
        if item % 2 != 0 {{
...
"
            ...
            DualAccum::ProductEleventhPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    prod: i64 = 1;
    for item in arr {{
        if item % 2 == 0 {{
...
"
            ...
            DualAccum::ProductEleventhPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    prod: i64 = 1;
    for item in arr {{
        if item % 2 != 0 {{
...
"
            ...
            DualAccum::MeanEleventhPowersEvenNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    n: i64 = 0;
    for item in arr {{
...
"
            ...
            DualAccum::MeanEleventhPowersOddNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    n: i64 = 0;
    for item in arr {{
...
"
            ...
            DualAccum::SumTwelfthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    for item in arr {{
        if item % 2 == 0 {{
...
"
            ...
            DualAccum::SumTwelfthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    for item in arr {{
        if item % 2 != 0 {{
...
"
            ...
            DualAccum::ProductTwelfthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    prod: i64 = 1;
    for item in arr {{
        if item % 2 == 0 {{
...
"
            ...
            DualAccum::ProductTwelfthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    prod: i64 = 1;
    for item in arr {{
        if item % 2 != 0 {{
...
"
            ...
            DualAccum::MeanTwelfthPowersEvenNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    n: i64 = 0;
    for item in arr {{
...
"
            ...
            DualAccum::MeanTwelfthPowersOddNonZeroTrunc => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    n: i64 = 0;
    for item in arr {{
...
"
            ...
            DualAccum::SumThirteenthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    for item in arr {{
        if item % 2 == 0 {{
...
"
            ...
            DualAccum::SumThirteenthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    for item in arr {{
        if item % 2 != 0 {{
...
"
            ...
            DualAccum::ProductThirteenthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    prod: i64 = 1;
    for item in arr {{
        if item % 2 == 0 {{
...
"
            ...
            DualAccum::ProductThirteenthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    prod: i64 = 1;
    for item in arr {{
        if item % 2 != 0 {{
...
"
            ...
            DualAccum::SumFourteenthPowersEvenNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    for item in arr {{
        if item % 2 == 0 {{
...
"
            ...
            DualAccum::SumFourteenthPowersOddNonZero => format!(
                "fn {fn_name}(arr: [i64]) -> i64 {{
    total: i64 = 0;
    for item in arr {{
        if item % 2 != 0 {{
...
enum KClosed {
    ...
    /// Min of |v| for non-zero elements divisible by k (none → 0; k == 0 → None).
    MinAbsNonZeroDivisibleByK,
    /// Truncating mean of |v| for non-zero elements divisible by k (none → 0; k == 0 → None).
    MeanAbsNonZeroDivisibleByKTrunc,
    /// XOR of non-zero elements divisible by k (none → 0; k == 0 → None).
    XorNonZeroDivisibleByK,
    /// Bitwise OR of non-zero elements divisible by k (none → 0; k == 0 → None).
    OrNonZeroDivisibleByK,
    /// Bitwise AND of non-zero elements divisible by k (none → -1; k == 0 → None).
    AndNonZeroDivisibleByK,
    /// Count of positive elements divisible by k (k == 0 → None).
    CountPositiveDivisibleByK,
    /// Count of negative elements divisible by k (k == 0 → None).
    CountNegativeDivisibleByK,
    /// Sum of positive elements divisible by k (none → 0; k == 0 → None).
    SumPositiveDivisibleByK,
    /// Sum of negative elements divisible by k (none → 0; k == 0 → None).
    SumNegativeDivisibleByK,
    /// Product of positive elements divisible by k (none → 1; k == 0 → None).
    ProductPositiveDivisibleByK,
    /// Product of negative elements divisible by k (none → 1; k == 0 → None).
    ProductNegativeDivisibleByK,
    /// Max of positive elements divisible by k (none → 0; k == 0 → None).
    MaxPositiveDivisibleByK,
    /// Min of positive elements divisible by k (none → 0; k == 0 → None).
    MinPositiveDivisibleByK,
    /// Max of negative elements divisible by k (none → 0; k == 0 → None).
    MaxNegativeDivisibleByK,
    /// Min of negative elements divisible by k (none → 0; k == 0 → None).
    MinNegativeDivisibleByK,
    /// First positive element divisible by k (none → -1; k == 0 → None).
    FirstPositiveDivisibleByK,
    /// Last positive element divisible by k (none → -1; k == 0 → None).
    LastPositiveDivisibleByK,
    /// First negative element divisible by k (none → -1; k == 0 → None).
    ...
    /// Truncating mean of negative elements divisible by k (none → 0; k == 0 → None).
    MeanNegativeDivisibleByKTrunc,
}
...
impl KClosed {
    fn label(self) -> &'static str {
        match self {
            ...
            KClosed::MinAbsNonZeroDivisibleByK => "min_abs_non_zero_divisible_by_k",
            KClosed::MeanAbsNonZeroDivisibleByKTrunc => "mean_abs_non_zero_divisible_by_k_trunc",
            KClosed::XorNonZeroDivisibleByK => "xor_non_zero_divisible_by_k",
            KClosed::OrNonZeroDivisibleByK => "or_non_zero_divisible_by_k",
            KClosed::AndNonZeroDivisibleByK => "and_non_zero_divisible_by_k",
            KClosed::CountPositiveDivisibleByK => "count_positive_divisible_by_k",
            KClosed::CountNegativeDivisibleByK => "count_negative_divisible_by_k",
            KClosed::SumPositiveDivisibleByK => "sum_positive_divisible_by_k",
            KClosed::SumNegativeDivisibleByK => "sum_negative_divisible_by_k",
            KClosed::ProductPositiveDivisibleByK => "product_positive_divisible_by_k",
            KClosed::ProductNegativeDivisibleByK => "product_negative_divisible_by_k",
            KClosed::MaxPositiveDivisibleByK => "max_positive_divisible_by_k",
            KClosed::MinPositiveDivisibleByK => "min_positive_divisible_by_k",
            KClosed::MaxNegativeDivisibleByK => "max_negative_divisible_by_k",
            KClosed::MinNegativeDivisibleByK => "min_negative_divisible_by_k",
            KClosed::FirstPositiveDivisibleByK => "first_positive_divisible_by_k",
            ...
            KClosed::MeanNegativeDivisibleByKTrunc => "mean_negative_divisible_by_k_trunc",
        }
    }
    ...
    fn eval(self, arr: &[i64], k: i64) -> Option<i64> {
        match self {
            ...
            KClosed::MinAbsNonZeroDivisibleByK => {
                if k == 0 {
                    return None;
                }
                let mut best: Option<i64> = None;
            ...
            KClosed::MeanAbsNonZeroDivisibleByKTrunc => {
                if k == 0 {
                    return None;
                }
                let xs: Vec<i64> = arr
            ...
            KClosed::XorNonZeroDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::AndNonZeroDivisibleByK => {
                if k == 0 {
                    return None;
                }
                let mut found = false;
                ...
                Some(if found { acc } else { -1 })
            }
            KClosed::CountPositiveDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(arr.iter().filter(|&&v| v > 0 && v % k == 0).count() as i64)
            }
            KClosed::CountNegativeDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(arr.iter().filter(|&&v| v < 0 && v % k == 0).count() as i64)
            }
            KClosed::SumPositiveDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::SumNegativeDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::ProductPositiveDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::ProductNegativeDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::MaxPositiveDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::MinPositiveDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::MaxNegativeDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::MinNegativeDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::FirstPositiveDivisibleByK => {
                if k == 0 {
                    return None;
                }
                Some(
            ...
            KClosed::MeanNegativeDivisibleByKTrunc => {
                if k == 0 {
                    return None;
                }
                let xs: Vec<i64> = arr.iter().copied().filter(|&v| v < 0 && v % k == 0).collect();
...
KClosed::MinWhereAbsNeK => format!(
    ...
    return best;\n\
            ...
            KClosed::MinAbsNonZeroDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    found: i64 = 0;\n\
    best: i64 = 0;\n\
    for item in arr {{\n\
    ...
    return best;\n\
            ...
            KClosed::MeanAbsNonZeroDivisibleByKTrunc => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    total: i64 = 0;\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
    ...
    return total / n;\n\
            ...
            KClosed::XorNonZeroDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    x: i64 = 0;\n\
    for item in arr {{\n\
        if item != 0 {{\n\
    ...
    return x;\n\
            ...
            KClosed::OrNonZeroDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    x: i64 = 0;\n\
    for item in arr {{\n\
        if item != 0 {{\n\
    ...
    return x;\n\
            ...
            KClosed::AndNonZeroDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    found: i64 = 0;\n\
    x: i64 = 0 - 1;\n\
    for item in arr {{\n\
    ...
    return x;\n\
            ...
            KClosed::CountPositiveDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
        if item > 0 {{\n\
    ...
    return n;\n\
            ...
            KClosed::CountNegativeDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
        if item < 0 {{\n\
    ...
    return n;\n\
            ...
            KClosed::SumPositiveDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    total: i64 = 0;\n\
    for item in arr {{\n\
        if item > 0 {{\n\
    ...
    return total;\n\
            ...
            KClosed::SumNegativeDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    total: i64 = 0;\n\
    for item in arr {{\n\
        if item < 0 {{\n\
    ...
    return total;\n\
            ...
            KClosed::ProductPositiveDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    prod: i64 = 1;\n\
    for item in arr {{\n\
        if item > 0 {{\n\
    ...
    return prod;\n\
            ...
            KClosed::ProductNegativeDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    prod: i64 = 1;
    for item in arr {{
        if item < 0 {{
...
"
            ...
            KClosed::MaxPositiveDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    best: i64 = 0;
    found: i64 = 0;
    for item in arr {{
...
"
            ...
            KClosed::MinPositiveDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    best: i64 = 0;
    found: i64 = 0;
    for item in arr {{
...
"
            ...
            KClosed::MaxNegativeDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    best: i64 = 0;
    found: i64 = 0;
    for item in arr {{
...
"
            ...
            KClosed::MinNegativeDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    best: i64 = 0;
    found: i64 = 0;
    for item in arr {{
...
"
            ...
            KClosed::FirstPositiveDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    for item in arr {{
        if item > 0 {{
            if item % k == 0 {{
...
"
            ...
            KClosed::LastPositiveDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    best: i64 = -1;
    for item in arr {{
        if item > 0 {{
...
"
            ...
            KClosed::FirstNegativeDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    for item in arr {{
        if item < 0 {{
            if item % k == 0 {{
...
"
            ...
            KClosed::LastNegativeDivisibleByK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    best: i64 = -1;
    for item in arr {{
        if item < 0 {{
...
"
            ...
            KClosed::MeanNegativeDivisibleByKTrunc => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{
    total: i64 = 0;
    n: i64 = 0;
    for item in arr {{
...
mod tests {
    ...
    fn index_scan_eval_helpers() {
        ...
        assert_eq!(DualAccum::ProductSeventhPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(-16384));
        assert_eq!(DualAccum::ProductSeventhPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(-2187));
        assert_eq!(DualAccum::ProductSeventhPowersEvenNonZero.eval(&[0, 1, 3]), Some(1));
        assert_eq!(KClosed::MinAbsNonZeroDivisibleByK.eval(&[0, -8, 4, 3], 2), Some(4));
        assert_eq!(DualAccum::MeanSeventhPowersEvenNonZeroTrunc.eval(&[0, -2, 2, 3]), Some(0));
        assert_eq!(DualAccum::MeanSeventhPowersOddNonZeroTrunc.eval(&[0, -3, 1, 2]), Some(-1093));
        assert_eq!(DualAccum::MeanSeventhPowersEvenNonZeroTrunc.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::MeanAbsNonZeroDivisibleByKTrunc.eval(&[0, -4, 6, 3], 2), Some(5));
        assert_eq!(DualAccum::SumEighthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(512));
        assert_eq!(DualAccum::SumEighthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(6562));
        assert_eq!(DualAccum::SumEighthPowersEvenNonZero.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::XorNonZeroDivisibleByK.eval(&[0, 4, 6, 3], 2), Some(2));
        assert_eq!(DualAccum::ProductEighthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(65536));
        assert_eq!(DualAccum::ProductEighthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(6561));
        assert_eq!(DualAccum::ProductEighthPowersEvenNonZero.eval(&[0, 1, 3]), Some(1));
        assert_eq!(KClosed::OrNonZeroDivisibleByK.eval(&[0, 4, 6, 3], 2), Some(6));
        assert_eq!(DualAccum::MeanEighthPowersEvenNonZeroTrunc.eval(&[0, -2, 2, 3]), Some(256));
        assert_eq!(DualAccum::MeanEighthPowersOddNonZeroTrunc.eval(&[0, -3, 1, 2]), Some(3281));
        assert_eq!(DualAccum::MeanEighthPowersEvenNonZeroTrunc.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::AndNonZeroDivisibleByK.eval(&[0, 4, 6, 3], 2), Some(4));
        assert_eq!(DualAccum::SumNinthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(0));
        assert_eq!(DualAccum::SumNinthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(-19682));
        assert_eq!(DualAccum::SumNinthPowersEvenNonZero.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::CountPositiveDivisibleByK.eval(&[0, -4, 6, 3], 2), Some(1));
        assert_eq!(DualAccum::ProductNinthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(-262144));
        assert_eq!(DualAccum::ProductNinthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(-19683));
        assert_eq!(DualAccum::ProductNinthPowersEvenNonZero.eval(&[0, 1, 3]), Some(1));
        assert_eq!(KClosed::CountNegativeDivisibleByK.eval(&[0, -4, 6, 3], 2), Some(1));
        assert_eq!(DualAccum::MeanNinthPowersEvenNonZeroTrunc.eval(&[0, -2, 2, 3]), Some(0));
        assert_eq!(DualAccum::MeanNinthPowersOddNonZeroTrunc.eval(&[0, -3, 1, 2]), Some(-9841));
        assert_eq!(DualAccum::MeanNinthPowersEvenNonZeroTrunc.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::SumPositiveDivisibleByK.eval(&[0, -4, 6, 3], 2), Some(6));
        assert_eq!(DualAccum::SumTenthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(2048));
        assert_eq!(DualAccum::SumTenthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(59050));
        assert_eq!(DualAccum::SumTenthPowersEvenNonZero.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::SumNegativeDivisibleByK.eval(&[0, -4, 6, 3], 2), Some(-4));
        assert_eq!(DualAccum::ProductTenthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(1048576));
        assert_eq!(DualAccum::ProductTenthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(59049));
        assert_eq!(DualAccum::ProductTenthPowersEvenNonZero.eval(&[0, 1, 3]), Some(1));
        assert_eq!(KClosed::ProductPositiveDivisibleByK.eval(&[0, -4, 6, 8], 2), Some(48));
        assert_eq!(DualAccum::MeanTenthPowersEvenNonZeroTrunc.eval(&[0, -2, 2, 3]), Some(1024));
        assert_eq!(DualAccum::MeanTenthPowersOddNonZeroTrunc.eval(&[0, -3, 1, 2]), Some(29525));
        assert_eq!(DualAccum::MeanTenthPowersEvenNonZeroTrunc.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::ProductNegativeDivisibleByK.eval(&[0, -4, 6, -8], 2), Some(32));
        assert_eq!(DualAccum::SumEleventhPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(0));
        assert_eq!(DualAccum::SumEleventhPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(-177146));
        assert_eq!(DualAccum::SumEleventhPowersEvenNonZero.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::MaxPositiveDivisibleByK.eval(&[0, -4, 6, 8], 2), Some(8));
        assert_eq!(DualAccum::ProductEleventhPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(-4194304));
        assert_eq!(DualAccum::ProductEleventhPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(-177147));
        assert_eq!(DualAccum::ProductEleventhPowersEvenNonZero.eval(&[0, 1, 3]), Some(1));
        assert_eq!(KClosed::MinPositiveDivisibleByK.eval(&[0, -4, 6, 8], 2), Some(6));
        assert_eq!(DualAccum::MeanEleventhPowersEvenNonZeroTrunc.eval(&[0, -2, 2, 3]), Some(0));
        assert_eq!(DualAccum::MeanEleventhPowersOddNonZeroTrunc.eval(&[0, -3, 1, 2]), Some(-88573));
        assert_eq!(DualAccum::MeanEleventhPowersEvenNonZeroTrunc.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::MaxNegativeDivisibleByK.eval(&[0, -4, 6, -8], 2), Some(-4));
        assert_eq!(DualAccum::SumTwelfthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(8192));
        assert_eq!(DualAccum::SumTwelfthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(531442));
        assert_eq!(DualAccum::SumTwelfthPowersEvenNonZero.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::MinNegativeDivisibleByK.eval(&[0, -4, 6, -8], 2), Some(-8));
        assert_eq!(DualAccum::ProductTwelfthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(16777216));
        assert_eq!(DualAccum::ProductTwelfthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(531441));
        assert_eq!(DualAccum::ProductTwelfthPowersEvenNonZero.eval(&[0, 1, 3]), Some(1));
        assert_eq!(KClosed::FirstPositiveDivisibleByK.eval(&[0, -4, 6, 8], 2), Some(6));
        assert_eq!(DualAccum::MeanTwelfthPowersEvenNonZeroTrunc.eval(&[0, -2, 2, 3]), Some(4096));
        assert_eq!(DualAccum::MeanTwelfthPowersOddNonZeroTrunc.eval(&[0, -3, 1, 2]), Some(265721));
        assert_eq!(DualAccum::MeanTwelfthPowersEvenNonZeroTrunc.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::LastPositiveDivisibleByK.eval(&[0, -4, 6, 8], 2), Some(8));
        assert_eq!(DualAccum::SumThirteenthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(0));
        assert_eq!(DualAccum::SumThirteenthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(-1594322));
        assert_eq!(DualAccum::SumThirteenthPowersEvenNonZero.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::FirstNegativeDivisibleByK.eval(&[0, -4, 6, -8], 2), Some(-4));
        assert_eq!(DualAccum::ProductThirteenthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(-67108864));
        ...
        assert_eq!(DualAccum::SumFourteenthPowersEvenNonZero.eval(&[0, -2, 2, 3]), Some(32768));
        assert_eq!(DualAccum::SumFourteenthPowersOddNonZero.eval(&[0, -3, 1, 2]), Some(4782970));
        assert_eq!(DualAccum::SumFourteenthPowersEvenNonZero.eval(&[0, 1, 3]), Some(0));
        assert_eq!(KClosed::MeanNegativeDivisibleByKTrunc.eval(&[0, -4, 6, -8], 2), Some(-6));
    }
}
