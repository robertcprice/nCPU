    ...
    fn eval(self, arr: &[i64]) -> Option<i64> {
        ...
        if arr.is_empty() {
            return match self {
                ...
                | DualAccum::AllOddNonNegative => Some(1),
                DualAccum::AndAll
                | DualAccum::AndAbsAll
...
impl KClosed {
    fn label(self) -> &'static str {
        match self {
            ...
            KClosed::CountWhereAbsEqK => "count_where_abs_eq_k",
        }
    }
...
KClosed::MinWhereAbsNeK => format!(
    ...
    return 0 - 1;\n\
            ...
            KClosed::CountWhereAbsEqK => format!(
                "fn {fn_name}(arr: [i64], k: i64) -> i64 {{\n\
    n: i64 = 0;\n\
    for item in arr {{\n\
        a: i64 = item;\n\
...
mod tests {
    ...
    fn index_scan_eval_helpers() {
        ...
        assert_eq!(KClosed::CountWhereAbsEqK.eval(&[-4, 2, 4], 4), Some(2));
    }
}
