...
Usage:
    ...
    # Or run directly
    python -m ncpu.self_optimizing.core.api_server
"""
...
def _load_request_bundle(request: BufferedInferenceRequest) -> Optional[Any]:
    ...
    from ncpu.self_optimizing.controller.bundle import load_controller_bundle
...
def _resolve_internal_controller_config(request: BufferedInferenceRequest) -> Any:
    from ncpu.self_optimizing.controller.internal_controller import InternalControllerConfig
...
def _load_request_latent_action_policy(request: BufferedInferenceRequest):
    from ncpu.self_optimizing.controller.runtime import load_bundle_latent_action_policy
...
def _load_request_latent_halt_policy(request: BufferedInferenceRequest):
    from ncpu.self_optimizing.controller.runtime import load_bundle_latent_halt_policy
...
def _load_request_latent_memory_updater(request: BufferedInferenceRequest):
    from ncpu.self_optimizing.controller.runtime import load_bundle_latent_memory_updater
...
if FASTAPI_AVAILABLE:
    ...
    def list_models():
        ...
        from ncpu.self_optimizing.core.model_zoo import get_model_zoo, OperationCategory
    ...
    def execute_model(name: str, input_data: Dict[str, Any]):
        ...
        from ncpu.self_optimizing.core.model_zoo import get_model_zoo
