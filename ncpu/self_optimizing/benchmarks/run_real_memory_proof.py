...
from ncpu.self_optimizing.latent_heads.memory_evaluation import evaluate_latent_memory_head
...
from ncpu.self_optimizing.benchmarks.run_qwen_benchmark import run_model_benchmark
