...
class LLMBenchmark:
    ...
    def _task_to_internal_task(self, task: BenchmarkTask) -> Any:
        from ncpu.self_optimizing.controller.internal_controller import InternalDeliberationTask
    ...
    def _buffered_task_result(
        ...
        *,
        ...
        from ncpu.self_optimizing.controller.internal_controller import BufferedInternalController
