...
from ncpu.self_optimizing.latent_heads.action_training import build_latent_action_training_bundle
from ncpu.self_optimizing.latent_heads.descriptor_training import build_latent_descriptor_training_bundle
