...
Usage:
    python main.py --program programs/arithmetic/sum_1_to_10.asm
    python main.py --program programs/arithmetic/fibonacci.asm --trace
...
def run_fast(args):
    ...
    if args.binary:
        ...
        print("Usage: python main.py --program programs/arithmetic/fibonacci.asm  (neural mode)")
...
Examples:
    ...
    python main.py --program programs/arithmetic/sum_1_to_10.asm --compute
