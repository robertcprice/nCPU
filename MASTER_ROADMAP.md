...
- **MORNING NUMBERS (2026-07-04 ~7am, clean window, binary 3fdf966)** — **MBPP 554/947 = 58.5% = 56.9% of ALL 974 | HumanEval 39/164 = 23.8%.** 22 decompose-schema solves on MBPP, 7 on HumanEval. Overnight arc complete: 12 schemas + string/compound sort keys + text signal + multi-input, ALL with the hand-op count frozen. Zero model, zero false positives, everything full-example verified.
